...
RSpec.configure do |config|
  ...
  # Enable enforcement of code coverage
  # config.after(:suite) do
  #   result = SimpleCov.result
  #   example_group = RSpec.describe('Code coverage')
  #   example = example_group.example('must be 100%') do
  #     expect(result.covered_percent).to be > 99
  #   end
  #   example_group.run
  #
  ...
  #   puts "Coverage report generated for RSpec, #{result.covered_lines} / #{result.total_lines} lines covered,"\
